...
const NOTIFICATIONS = [
  {
    ...
    message: 'Transaksi pembelian ATK berhasil diklasifikasikan ke akun Beban.',
    time: '2 menit lalu',
    unread: true,
  },
  {
    ...
    icon: '📊',
    title: 'Laporan Siap',
    message: 'Laporan analitik bulan Juni 2026 telah selesai diproses.',
    time: '1 jam lalu',
    unread: true,
  },
  {
    ...
    type: 'warning',
    icon: '⚠️',
    title: 'Aturan Perlu Ditinjau',
    message: '3 aturan dalam basis pengetahuan berstatus Draft dan belum aktif.',
    time: '3 jam lalu',
    unread: true,
  },
  {
    ...
    message: 'Mesin inferensi backward chaining diperbarui ke versi v2.4.0.',
    time: 'Kemarin',
    unread: false,
  },
];
...
const typeColorMap = {
  success: { bg: '#ecfdf5', border: '#a7f3d0', dot: '#10b981' },
    ...
    <>
      ...
      <header
        style={{
          ...
          padding: '1rem 2rem',
          /* Bleed out of .main-content's 2rem padding to sit flush */
          ...
          <div ref={bellRef} style={{ position: 'relative' }}>
            <button
              ...
              style={{
                ...
                height: '46px',
                borderRadius: 'var(--radius-md)',
                border: bellOpen ? '1.5px solid var(--primary)' : '1.5px solid var(--border)',
                backgroundColor: bellOpen ? 'var(--primary-light)' : 'var(--surface)',
                color: bellOpen ? 'var(--primary)' : 'var(--text-secondary)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                cursor: 'pointer',
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor: notif.unread ? `${colors.bg}` : 'transparent',
                          position: 'relative',
                        }}
                      >
                        {/* Unread dot */}
